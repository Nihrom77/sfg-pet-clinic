...
@Service
@Profile({"default", "map"})
public class OwnerMapService extends AbsctractMapService<Owner, Long> implements OwnerService {
    ...
    public Owner findByLastName(String lastName) {
        return this.findAll().stream().filter(owner -> lastName.equals(owner.getLastName()))
